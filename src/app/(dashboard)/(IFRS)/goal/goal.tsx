    ...
    <div className="flex flex-col w-full h-full p-4 pt-24">
      ...
      <motion.div
        ...
        <Card className="border-2 border-customG/20">
          <CardContent className="flex items-center p-4">
            <div className="p-2 mr-3 rounded-full bg-customG/10">
              <Target className="w-5 h-5 text-customG" />
            </div>
            <div>
        ...
        <Card className="border-2 border-customG/20">
          <CardContent className="flex items-center p-4">
            <div className="p-2 mr-3 rounded-full bg-customG/10">
              <ArrowDown className="w-5 h-5 text-customG" />
            </div>
            <div>
          ...
          <div className="bg-white rounded-b-lg">
            <Accordion type="multiple" className="p-4">
              <AccordionItem
                ...
                <AccordionTrigger className="px-4 py-3 text-base font-medium">
                  <div className="flex items-center gap-2">
                    <Badge variant="outline" className="border-black bg-[#0D1359]">
                      <span className="text-white">{netZeroData.length}</span>
                    </Badge>
                    <p className="text-sm font-medium text-[#0D1359]">넷제로 분석 결과</p>
                  </div>
                </AccordionTrigger>
                      ...
                      <div className="flex flex-col items-center justify-center p-8 space-y-4">
                        ...
                        <div className="max-w-sm space-y-2">
                          ...
                          <p className="text-sm text-slate-500">
                            기업의 온실가스 배출량 감축 목표를 설정하고 관리하세요. 탄소
                            중립으로 가는 여정의 첫 걸음입니다.
                          </p>
                        </div>
                        {/* ------------------------------------------------------------------- */}
                          ...
                          <Line
                            ...
                            options={{
                              ...
                              plugins: {
                                ...
                                datalabels: {
                                  display: (context: any) => context.datasetIndex === 0,
                                  align: -10 as const,
                                  anchor: 'end',
                                  offset: 4,
                                  color: '#059669',
              ...
              <AccordionItem
                ...
                <AccordionTrigger className="px-4 py-3 text-base font-medium">
                  <div className="flex items-center gap-2">
                    <Badge variant="outline" className="border-black bg-customG">
                      <span className="text-white">{kpiGoalData.length}</span>
                    </Badge>
                    <p className="text-sm font-medium text-customG">KPI 목표</p>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="p-4">
                  {loading ? (
