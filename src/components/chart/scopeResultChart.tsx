...
const DEFAULT_DATA: ScopeData = {
  scope1: {direct: 1000, indirect: 800},
  scope2: {electricity: 800, steam: 500}
}
...
export default function ScopeResultChart({
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-full p-4 bg-white border shadow-sm rounded-xl">
      <div className="h-44">
