  ...
  return (
    <div className="flex flex-col w-full h-full p-4 pt-24">
      ...
      <div
        ...
        className="flex items-start gap-3 px-4 py-3 mb-4 transition rounded-md cursor-pointer hover:bg-gray-100 w-fit">
        <ArrowLeft className="w-5 h-5 mt-1 text-gray-500 hover:text-blue-600" />
