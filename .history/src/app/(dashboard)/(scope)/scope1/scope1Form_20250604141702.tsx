  ...
  return (
    <div className="flex flex-col w-full h-full p-4 pt-24">
      ...
      <div
        ...
        className="flex items-start gap-2 p-2 mb-2 transition rounded-md cursor-pointer hover:bg-gray-100 w-fit">
        <div className="mt-1.5">
          <ArrowLeft className="w-5 h-4 text-gray-500 group-hover:text-blue-600" />
        </div>
