...
export default function Scope1Form() {
  ...
  return (
    <div className="flex flex-col w-full h-full p-4 pt-24">
      ...
      {/* 뒤로가기 아이콘 버튼 (PageHeader 바깥에 위치) */}
      <button
        onClick={() => router.push('/home')}
        className="flex items-center px-2 py-1 mb-2 text-gray-500 transition rounded-md w-fit hover:text-blue-600 hover:bg-gray-100">
