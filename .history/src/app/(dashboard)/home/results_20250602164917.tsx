              ...
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="flex items-center gap-2">
                    ...
                    <span className="text-xl text-blue-800">공급망 ESG 현황</span>
                  </CardTitle>
                  <Badge variant="outline" className="text-blue-700 bg-blue-50">
                    실시간 데이터
                  </Badge>
                </div>
                <CardDescription>협력사 ESG 데이터 수집 현황</CardDescription>
              </CardHeader>
              ...
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="flex items-center gap-2">
                    ...
                    <span className="text-xl text-green-800">배출량 모니터링</span>
                  </CardTitle>
                  <Badge variant="outline" className="text-green-700 bg-green-50">
                    실시간 데이터
                  </Badge>
                </div>
                <CardDescription>Scope 1, 2 배출량 현황</CardDescription>
              </CardHeader>
              <CardContent className="flex items-center justify-center pt-2 h-60">
                <div className="flex flex-col gap-3 w-[280px]">
                  {mounted && <CsdddChart refreshTrigger={refreshTrigger} />}
