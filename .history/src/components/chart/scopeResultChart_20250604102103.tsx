...
export default function ScopeResultChart({refreshTrigger = 0}: ScopeResultChartProps) {
  ...
  const chartOptions = {
    ...
    responsive: true,
    layout: {
      padding: {bottom: 50} // ✅ x축 레이블이 안겹치게
    },
    scales: {
      x: {
        ticks: {
  ...
  return (
    <div className="grid items-start w-full grid-cols-1 gap-6 md:grid-cols-2">
      {/* Bar Chart */}
      ...
      {/* Info Box */}
      <div className="w-full flex flex-col justify-start gap-6 text-sm min-w-[180px]">
        {/* 총합 배출 */}
