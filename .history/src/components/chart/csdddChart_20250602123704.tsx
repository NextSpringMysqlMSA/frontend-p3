...
export default function SelfCheckChart({refreshTrigger = 0}: {refreshTrigger?: number}) {
    ...
    datasets: [
      {
        ...
        backgroundColor: ['#f59e0b', '#fef3c7'], // amber
  ...
  return (
    <div className="relative w-48 h-48">
      ...
      <div className="absolute text-3xl font-bold transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 text-amber-600">
        {data.completionRate}%
      </div>
    </div>
  )
