        ...
        <NavigationMenu>
          <NavigationMenuList className="flex flex-row items-center justify-center w-full h-full space-x-5 ">
            ...
            <NavigationMenuItem className="relative">
              ...
              <NavigationMenuContent className="absolute top-full mt-2 min-w-[160px] rounded-md bg-white shadow-lg border border-gray-200 z-50">
                <NavigationMenuLink
                  href="/scope1"
                  className="block w-full px-4 py-2 text-base hover:bg-gray-100 whitespace-nowrap">
                  Scope 1
                </NavigationMenuLink>
                <NavigationMenuLink
                  href="/scope2"
